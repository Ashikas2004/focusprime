  ...
  if (isRunning) {
    ...
    timerInterval = setInterval(() => {
      if (currentTime > 0) {
        ...
        // Show notification and play sound first
        showBrowserNotification("Time's up! Task completed.");
        setTimeout(() => {
          // Delay the alert message to allow the notification and sound to execute
          window.alert("Time's up! Task completed.");
          // Mark the task as completed in the UI and DB
